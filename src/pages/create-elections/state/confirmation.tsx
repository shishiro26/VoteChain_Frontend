...
//   const { toast } = useToast()
  ...
  useEffect(() => {
    ...
    //     variant: "destructive",
    //   })
      router.push("/admin/create-election")
      return
    }
    ...
    <div>
      <AdminBreadcrumb
        items={[
          ...
          { label: "Upload Template", href: "/admin/create-election/state/upload-template" },
          { label: "Confirmation" },
        ]}
      />
      <h1 className="text-3xl font-bold mb-4">Confirm Election Details</h1>

      <ProgressSteps steps={["Election Details", "Upload Template", "Confirmation"]} currentStep={2} />
      ...
      <Card className="max-w-4xl mb-6">
        <CardHeader className="bg-primary/5 border-b border-border">
          <div className="flex justify-between items-start">
            <div>
              ...
              <CardDescription className="mt-1">{electionData.purpose}</CardDescription>
            </div>
        ...
        <CardContent className="pt-6">
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h3 className="text-sm font-medium text-muted-foreground">Election Period</h3>
                <p>
            ...
            <div className="pt-4 border-t">
              <h3 className="text-sm font-medium text-muted-foreground mb-2">Candidate Summary</h3>
        ...
        <CardFooter className="border-t border-border pt-4 flex justify-between">
          <Button variant="outline" onClick={() => router.push("/admin/create-election/state/upload-template")}>
            Back
          </Button>
      ...
      <Card>
        ...
        <CardContent>
          <ol className="space-y-4 list-decimal list-inside">
            <li className="pl-2">
              <span className="font-medium">Election Creation:</span> The election will be created with all the details
              you provided.
            </li>
            <li className="pl-2">
              <span className="font-medium">Candidate Processing:</span> Candidates from your template will be processed
              and added to the election.
            </li>
            <li className="pl-2">
              <span className="font-medium">Constituency Assignment:</span> Candidates will be assigned to their
              respective constituencies.
            </li>
            <li className="pl-2">
              <span className="font-medium">Notification:</span> Eligible voters will be notified about the upcoming
              election.
            </li>
            <li className="pl-2">
              <span className="font-medium">Activation:</span> The election will be activated on the start date you
              specified.
            </li>
          </ol>
        </CardContent>
