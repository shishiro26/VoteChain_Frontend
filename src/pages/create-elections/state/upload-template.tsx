...
//   const { toast } = useToast()
  ...
  const handleUpload = () => {
    ...
    //   })
      ...
      router.push("/admin/create-election/state/confirmation")
    }, 2000)
  }
  ...
  return (
    <div>
      ...
      <ProgressSteps steps={["Election Details", "Upload Template", "Confirmation"]} currentStep={1} />
      ...
      <Card className="max-w-4xl">
        ...
        <CardContent className="space-y-6">
          <Alert>
            ...
            <AlertDescription>
              The template contains columns for Candidate Name, Party, Constituency, and Image URL. Please fill all
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4">
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Download the Excel template and fill in the candidate details according to the instructions.
              </p>
            </div>
          ...
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium mb-2">Step 2: Upload Completed Template</h3>
            <p className="text-sm text-muted-foreground mb-4">
          ...
          <div className="flex justify-end space-x-4 pt-4">
            <Button variant="outline" onClick={() => router.push("/admin/create-election/state")}>
              Back
            </Button>
