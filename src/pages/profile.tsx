...
export default function ProfilePage() {
  ...
  }, [wallet, isProfileComplete, router])
      ...
      <div className="container mx-auto px-4 py-12">
        <Card className="max-w-md mx-auto">
          <CardHeader>
            ...
            <CardDescription>Please connect your MetaMask wallet to view your profile.</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="container mx-auto px-4 py-12">
        <Card className="max-w-md mx-auto">
          <CardHeader>
            ...
            <CardDescription>Please complete your profile before accessing this page.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button onClick={() => router.push("/update-profile")} className="w-full">
              Update Profile
            </Button>
          </CardContent>
        </Card>
        ...
        <div className="lg:col-span-1">
          <Card className="border border-border">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-green-500">{userData.verificationStatus}</p>
                  </div>
                </div>
            ...
            <CardFooter className="border-t border-border pt-4">
              <Button variant="outline" className="w-full" onClick={() => router.push("/update-profile")}>
                Update Profile
              </Button>
            </CardFooter>
          </Card>
        ...
        <div className="lg:col-span-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Record of your past votes on the blockchain</CardDescription>
            </CardHeader>
            <CardContent>
