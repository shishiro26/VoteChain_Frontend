...
import { BarChart3, CalendarPlus, ChevronLeft, ChevronRight, Home, Medal, UserCheck, Users } from "lucide-react"
...
const AdminSidebar = () => {
  ...
  const navigation = [
    ...
    { name: "Create Election", href: "/admin/create-election", icon: CalendarPlus },
      ...
      <div className="p-4 border-t border-sidebar-border">
        <TooltipProvider delayDuration={0}>
          <Tooltip>
            ...
            {collapsed && <TooltipContent side="right">Back to Main Site</TooltipContent>}
          </Tooltip>
        </TooltipProvider>
      </div>
    </div>
